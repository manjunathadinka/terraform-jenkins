...
The jenkins directory contains an example of the Jenkinsfile (i.e. Pipeline) the scripts subdirectory contains a shell script with commands that are executed when Jenkins processes the "Deliver" stage of the Pipeline.
